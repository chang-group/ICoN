...
if __name__=='__main__':
    ...
    datTE = B.Coords2MainVecs(xyz_te)
    ...
    for epoch in tqdm.tqdm(range(iStart, iEnd)):
        ...
        TE = np.random.randint(0, n_test, batch_size)
        lossTE = run_model(datTE, modelE, modelD, TE, train = False, device=device)
